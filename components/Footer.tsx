      ...
      <div className="w-10/12 mx-auto flex flex-col justify-between py-6 text-white">
        ...
        <section className="flex mt-8 mb-8">
            <div className="flex-1">
                <p className="leading-6 text-xs text-[#FFF] opacity-50">Audiophile is an all in one stop to fulfill your audio needs. We are a small team of music lovers and sound specialists who are devoted to helping you get the most out of personal audio. Come and visit our demo facility - we’re open 7 days a week.
                </p>
